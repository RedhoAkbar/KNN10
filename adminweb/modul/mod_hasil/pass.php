...
$tampil = mysql_query("SELECT hasil.jarak,sampel.pemilik,sampel.kelayakan FROM hasil,sampel WHERE hasil.id_data=$id AND hasil.id_pemilik = sampel.id ORDER BY hasil.jarak DESC");
$no=$posisi+1;
while ($r=mysql_fetch_array($tampil)){
	echo "<tr>
			<td>$no</td>
